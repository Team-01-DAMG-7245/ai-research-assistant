...
class PDFTableExtractor:
    ...
    def extract_tables_from_page(self, pdf_path: str, page_num: int) -> Dict:
        """
        ...
        tables = camelot.read_pdf(pdf_path, flavor=flavor, pages=str(page_num))
    ...
    def extract_tables_from_pdf(
        self, pdf_path: str, pages: List[int] = None, output_dir: str = None
    ) -> Dict:
        """
        ...
        results = {"pdf_name": pdf_path.name, "pages_processed": [], "total_tables": 0}
        ...
        self.logger.info(
            f"Extracted {results['total_tables']} tables from {len(pages)} pages"
        )
...
if __name__ == "__main__":
    ...
    result = extractor.extract_tables_from_pdf(
        "./data/raw/test.pdf", pages=[1, 2, 3], output_dir="./data/processed/tables"
    )
