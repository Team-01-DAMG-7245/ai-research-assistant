...
class ReviewRequest(BaseModel):
    ...
    edited_report: Optional[str] = Field(default=None, description="Edited report content (required for edit action)")
    rejection_reason: Optional[str] = Field(default=None, max_length=500, description="Reason for rejection (required for reject action)")
